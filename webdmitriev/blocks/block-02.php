  ...
  <?php if( !is_admin() ) : ?>
    <div class="container">
      <div class="parket__inner">
        <h2 class="parket__title section__title"><?= $title; ?></h2>
        <p class="parket__subtitle"><?= $sub_title; ?></p>
        <div class="parket__text-row">
          <div class="parket__block">
            <p class="parket__text-title"><?= $text_title; ?></p>
            <div class="parket__text"><?= $text_pd; ?></div>
          </div>
          <img src="<?= $image_pd; ?>" class="parket__img">
        </div>
